...
public class PunktTarcza extends Thread {
    private int x,y,w=25,h=25;
    JPanel panel;
   Image imgPunkt = new ImageIcon(getClass().getClassLoader().getResource("punktTarcza.png")).getImage();
    public PunktTarcza(int x, int y, JPanel panel){
        this.x=x;
        this.y=y;
        this.panel=panel;
    }
