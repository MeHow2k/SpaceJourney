...
public class PunktZycie extends Thread {
    private int x,y,w=25,h=25;
    JPanel panel;
   Image imgPunkt = new ImageIcon(getClass().getClassLoader().getResource("zycie.gif")).getImage();
    public PunktZycie(int x, int y, JPanel panel){
        this.x=x;
        this.y=y;
        this.panel=panel;
    }
